...
export function GameView({ initialData, onSaveGame }: GameViewProps) {
  ...
  }, [addDebugMessage, addDebugMessages, addMessage, addMessages, buildConversationHistory, gameState, inCombat, locationId, party, initiativeOrder, enemies, turnIndex, debugMessages]);
