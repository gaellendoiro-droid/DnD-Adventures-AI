...
const NarrativeExpertInputSchema = z.object({
  ...
  party: z.array(CharacterSchema).describe("The full data for the player's party. This is for tool use."),
