...
6.  **Attack Flow:** For an attack action, first make the attack roll. In your narration, describe whether the attack hits or misses. ONLY if the attack hits, then make and describe the damage roll. Both rolls (attack and damage if applicable) must be returned in the \`diceRolls\` field.
