...
export const initialMessage: GameMessage = {
  ...
  sender: "DM",
  content: `<h3>¡Bienvenidos a la aventura "El Dragón del Pico Agujahelada"!</h3><p>Vuestro grupo se encuentra en el pueblo de Phandalin, un modesto asentamiento minero enclavado en las laderas de las Montañas de la Espada. El aire es frío y el ambiente, tenso. Un joven y feroz dragón blanco llamado <strong>Cryovain</strong> ha hecho del cercano Pico Agujahelada su guarida, sembrando el caos y expulsando a otras bestias peligrosas hacia las tierras civilizadas.</p><p>Os encontráis en la plaza del pueblo, un espacio abierto rodeado de edificios de madera y viejas ruinas de piedra. Frente a la casa consistorial, un tablón de anuncios de madera llama vuestra atención. En él, varios carteles escritos con una caligrafía nerviosa ofrecen recompensas por diversos trabajos. Parece el lugar perfecto para un grupo de aventureros en busca de gloria y fortuna.</p><p>El futuro de Phandalin es incierto, y sus gentes necesitan héroes. ¿Qué hacéis?</p>`,
  originalContent: `¡Bienvenidos a la aventura "El Dragón del Pico Agujahelada"! Vuestro grupo se encuentra en el pueblo de Phandalin, un modesto asentamiento minero enclavado en las laderas de las Montañas de la Espada. El aire es frío y el ambiente, tenso. Un joven y feroz dragón blanco llamado Cryovain ha hecho del cercano Pico Agujahelada su guarida, sembrando el caos y expulsando a otras bestias peligrosas hacia las tierras civilizadas. Os encontráis en la plaza del pueblo, un espacio abierto rodeado de edificios de madera y viejas ruinas de piedra. Frente a la casa consistorial, un tablón de anuncios de madera llama vuestra atención. En él, varios carteles escritos con una caligrafía nerviosa ofrecen recompensas por diversos trabajos. Parece el lugar perfecto para un grupo de aventureros en busca de gloria y fortuna. El futuro de Phandalin es incierto, y sus gentes necesitan héroes. ¿Qué hacéis?`,
